...
function App() {
          ...
          <div className="header-section">
            <h1>
              <a className="navbar-brand logo editContent" href="index.html">
                <span className="fa fa-life-ring" />DE-ADDICTION
              </a>
            </h1>
          </div>
  ...
  <section className="tabs-blue py-5">
    <div className="container pt-md-5">
      ...
      <div className="tab-main mx-auto">
        ...
        <input id="tab4" type="radio" className="w3layouts-sm" name="tabs" />
        <label htmlFor="tab4">Others</label>
        <section id="content1" className="inner-w3layouts-wrap">
          <div className="row part-grids text-center inner-sec-w3ls">
            <div className="col-md-6 partgrid2">
              <div className="thumbnail card">
                <div className="img-event">
                  <img className="img-fluid" src="images/g1.jpeg" alt="" />
                </div>
                <div className="caption card-body p-md-4">
                  <h4 className="mb-4 editContent">`Natural Drugs </h4>
                  <p>
                    Natural drugs are derived from substances found in nature, such as plants. These drugs have been used for centuries for various purposes, including medicinal, recreational, or spiritual use. Examples of natural drugs include marijuana, opium, psilocybin mushrooms, and cocaine derived from the coca plant.</p>
                </div>
              </div>
            </div>
            <div className="col-md-6 partgrid1">
              <div className="thumbnail card">
                <div className="img-event">
                  <img className="img-fluid" src="images/g2.jpeg" alt="" />
                </div>
                <div className="caption card-body p-md-4">
                  <h4 className="mb-4 editContent">Synthetic Drug</h4>
                  <p>
                    synthetic drugs are artificially created in laboratories and are designed to mimic the effects of natural substances or create entirely new effects. These drugs are often produced through chemical processes using various compounds. Synthetic drugs include substances like MDMA (ecstasy), methamphetamine, synthetic cannabinoids, and synthetic opioids.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="content2" className="inner-w3layouts-wrap">
          <div className="row part-grids text-center">
            <div className="col-md-6 partgrid2">
              <div className="thumbnail card">
                <div className="img-event">
                  <img className="img-fluid" src="images/g3.jpeg" alt="" />
                </div>
                <div className="caption card-body p-md-4">
                  <h4 className="mb-4 editContent">Social Media </h4>
                  <p>
                    Social media addiction is a pervasive issue characterized by excessive use and dependency on social media platforms, often resulting in decreased productivity, isolation, and negative impacts on mental health.</p>
                </div>
              </div>
            </div>
            <div className="col-md-6 partgrid1">
              <div className="thumbnail card">
                <div className="img-event">
                  <img className="img-fluid" src="images/g10.jpeg" alt="" />
                </div>
                <div className="caption card-body p-md-4">
                  <h4 className="mb-4 editContent">Technology Dependency</h4>
                  <p>
                    Technology Dependency refers to the excessive reliance and attachment to electronic devices beyond social media platforms, such as smartphones, laptops, tablets, and gaming consoles. It involves compulsive use and difficulty in controlling the time spent on these devices</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="content3" className="inner-w3layouts-wrap">
          <div className="row part-grids text-center">
            <div className="col-md-6 partgrid2">
              <div className="thumbnail card">
                <div className="img-event">
                  <img className="img-fluid" src="images/g6.jpg" alt="" />
                </div>
                <div className="caption card-body p-md-4">
                  <h4 className="mb-4 editContent">Praesent ullamcorper </h4>
                  <p>
            ...
            <div className="col-md-6 partgrid1">
              <div className="thumbnail card">
                <div className="img-event">
                  <img className="img-fluid" src="images/g7.jpg" alt="" />
                </div>
                <div className="caption card-body p-md-4">
                  <h4 className="mb-4 editContent">Praesent ullamcorper </h4>
                  <p>
        ...
        <section id="content4" className="inner-w3layouts-wrap">
          <div className="row part-grids text-center">
            <div className="col-md-6 partgrid2">
              <div className="thumbnail card">
                <div className="img-event">
      ...
      <div className="row footer-top">
        <div className="col-lg-4 footer-grid_section_w3layouts">
          <h2 className="logo-2 mb-lg-4 mb-3">
            <a href="index.html"><span className="fa fa-life-ring" />DE-ADDICTION</a>
          </h2>
  ...
  <div className="cpy-right py-3">
    <div className="container">
      <div className="row">
        <p className="col-md-10 text-left">© 2023 DE-ADDICTION. All rights reserved </p>
        {/* move top icon */}
